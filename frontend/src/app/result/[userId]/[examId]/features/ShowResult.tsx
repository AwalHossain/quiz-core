...
export default function ShowResult({ result }: { result: ExamResult }) {
    ...
    const scorePercentage = (result.totalScore / totalQuestions) * 100

    const chartData = [
        { name: 'Correct', value: result.correctCount, color: 'hsl(var(--chart-1))' },
        { name: 'Incorrect', value: result.wrongCount, color: 'hsl(var(--chart-2))' },
        { name: 'Skipped', value: result.skippedCount, color: 'hsl(var(--chart-3))' },
    ]
                        ...
                        <div className="space-y-2">
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-2xl font-bold">{formatTime(result.exam.examSession[0].totalTimeSpent)}</p>
                                </div>
                                <div className="space-y-2">
                                    <p className="text-sm font-medium text-muted-foreground">Position</p>
                                    <p className="text-2xl font-bold">{result.position}<small>st</small>
                                    </p>
                                </div>
                            </div>
                        </div>
